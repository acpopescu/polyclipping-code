#local conan build file test from recipe
...
class ClipperConan(ConanFile):
    ...
    def layout(self):
        ...
        self.cpp.package.includedirs = ["cpp"]
        self.cpp.package.set_property("pkg_config_name", "polyclipping")
        self.cpp.package.libs = ["polyclipping"]
    def generate(self):
